...
const Footer = () => {
  return (
    <div className="bg-gray-700 text-white sm:flex flex-row  items-center justify-center py-4  md:gap-160 mt-20 w-full ">
      <div className="">
        <img src={assets.logo} alt="" />
        <p>Copyright © 2025 Quick Visuals | All rights reserved</p>
      </div>
